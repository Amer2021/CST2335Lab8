...
public class ProfileActivity extends AppCompatActivity {
    ...
    void initData() {
        ...
        /*initializing button by loading the view attached to this
         *layout bearing the id name : toolbarButton
         */
        ...
        /*Implementing a listener on the toolBar button to listen for button click event
         *onClick event is set to open a new Activity (TestToolbar activity)
         */
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        //check if the requestCode returned is 500.
        if(resultCode == TEST_TOOLBAR_RESULT){
            //if 500 returned, start the login activity
